...
<html>
<head>
	<title>DATA TABLE GAME</title>
	<?php require_once "scripts.php";  ?>
</head>
<body>
<body align="right" background="multimedia/banner1.jpg"></body>
			...
			<div class="col-sm-12">
				<div class="card text-left">
					<div align="center" class="card-header">
						TABLA DINAMICA CON DTA TABLEY PHP
					</div>
					<div class="card-body">
                    <span class="btn btn-primary" data-toggle="modal" data-target=
                        "#agregarnuevosdatosmodal">
					...
					<div class="card-footer text-muted">
						By JOSE ANTONIO CARRILLO ALEJANDRO 
					</div>
				</div>
			</div>
		</div>
